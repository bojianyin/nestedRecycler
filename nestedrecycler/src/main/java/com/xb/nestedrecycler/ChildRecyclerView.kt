...
open class ChildRecyclerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    var mParentRecyclerView: com.xb.nestedrecycler.ParentRecyclerView? = null
    ...
    private fun findParentRecyclerView(): com.xb.nestedrecycler.ParentRecyclerView? {
        var parentView = parent
        while ((parentView is com.xb.nestedrecycler.ParentRecyclerView).not()) {
            parentView = parentView.parent
        }
        return parentView as? com.xb.nestedrecycler.ParentRecyclerView
    }
